...
import { FileText, ImageIcon, PenLine, Globe, Search, Home } from "lucide-react";
              ...
              <Card className="hover:border-primary/50 transition-colors cursor-pointer h-full">
                <CardHeader>
                  <CardTitle className="text-base flex items-center gap-2">
                    <Globe className="h-5 w-5 text-primary" /> URL 크롤링
                  </CardTitle>
                </CardHeader>
                <CardContent>
          ...
          <StaggerItem>
            <Link href="/search">
              <Card className="hover:border-primary/50 transition-colors cursor-pointer h-full">
                <CardHeader>
                  <CardTitle className="text-base flex items-center gap-2">
                    <Search className="h-5 w-5 text-primary" /> 논문 검색
                  </CardTitle>
                </CardHeader>
                <CardContent>
          ...
          <StaggerItem>
            <Link href="/image">
              <Card className="hover:border-primary/50 transition-colors cursor-pointer h-full">
                <CardHeader>
                  <CardTitle className="text-base flex items-center gap-2">
                    <ImageIcon className="h-5 w-5 text-primary" /> AI 이미지 생성
                  </CardTitle>
                </CardHeader>
                <CardContent>
